...
def test_rwlock_direct_acquire_release():
    """
    Verify direct acquire_read/release_read and acquire_write/release_write
...
def test_rwlock_direct_try_acquire():
    """
    Verify try_acquire_read and try_acquire_write on RwLock.
    """
    lock = RwLock()
...
def test_rwlock_direct_concurrent_performance():
    """
    Concurrent multi-threaded test using direct acquire_read/release_read.
    """
    lock = RwLock()
    shared_counter = [0]
    errors = []
